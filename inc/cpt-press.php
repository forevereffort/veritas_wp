<?php
function registerPressPostType()
{
    $labels = [
        'name'                  => _x('Press', 'Press General Name', 'veritas'),
        'singular_name'         => _x('Press', 'Press Singular Name', 'veritas'),
        'menu_name'             => __('Press', 'veritas'),
        'name_admin_bar'        => __('Press', 'veritas'),
    ...
    $args = [
        'label'                 => __('Press', 'veritas'),
        'description'           => __('Press Description', 'veritas'),
        'labels'                => $labels,
        'supports'              => ['title'],
        'hierarchical'          => false,
        'public'                => true,
...
add_action('init', 'registerPressPostType');