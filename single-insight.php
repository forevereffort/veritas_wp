      ...
      <div class="md-12">
        <div class="secondaryHeaderWrap">
          ...
          <div class="socialWrap">
            <small>Share</small>
            <a class="hoverEffect_dim" href="https://www.facebook.com/sharer.php?u=<?php echo get_permalink(); ?>" target="_blank" rel="noopener noreferrer">
            ...
            <a class="hoverEffect_dim" href="https://twitter.com/intent/tweet?url=<?php echo get_permalink(); ?>" target="_blank" rel="noopener noreferrer">
            ...
            <div class="toClipboardBtn" data-copyThisUrl="<?php echo get_permalink(); ?>">
