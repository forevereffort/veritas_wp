...
<main>
  ...
  ?>
            ...
            <div class="r">
              ...
              <div class="md-6 lg-4">
                <div class="bigimg-info__info">
                  <p class="s"><?php echo get_field('publication_name', $featured_article_large[0]->ID); ?></p>
        ...
        <div class="card-grid">
          <div class="g">
            <?php echo do_shortcode('[ajax_load_more container_type="div" css_classes="r rowMargin" repeater="template_5" post_type="press" posts_per_page="8" post__not_in="' . $featured_article_large[0]->ID . '" scroll="false" transition="none" transition_container="false"]'); ?>
              <?php
                /*$args = array(
                  'post_type' => 'press',
                    ...
                    <div class="lg-3 md-6">
                      <div class="card-grid__card">
                        ...
                        <div class="card-grid__card-info">
                          <p class="s"><?php echo get_field('publication_name'); ?></p>
