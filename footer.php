            ...
            <div class="mdlg-6 md-4">
              <div class="eachInfoBox">
                ...
                <p class="s">
                  ...
                  Sat to Sun: 11am - 6pm <br>
                  PH: By appointment only.</p>
              </div>
            </div>
            <div class="mdlg-6 md-4">
              <div class="eachInfoBox">
                <p class="s">Connect</p>
                <p class="s"><a class="hoverEffect_dim" target="_blank" href="mailto:ask@veritas.com.sg">ask@veritas.com.sg</a></p>
                <p class="s"><a class="hoverEffect_dim" target="_blank" href="tel:+6562833885">+65 6283 3885 <sup>Tel</sup></a></p>
                <p class="s"><a class="hoverEffect_dim" target="_blank" href="https://api.whatsapp.com/send?phone=6581299789">+65 8129 9789 <sup>Whatsapp</sup></a></p>
              </div>
            </div>
            <div class="mdlg-6 md-4">
              <div class="eachInfoBox">
